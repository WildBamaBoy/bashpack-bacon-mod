...
public class WorldGenMinableBashurverse extends WorldGenerator
{
    ...
    public WorldGenMinableBashurverse(int par1, int par2)
    {
        this(par1, par2, BashPackCore.instance.blockCrispyBacon.blockID);
    }

    public WorldGenMinableBashurverse(int par1, int par2, int par3)
    {
    ...
    public WorldGenMinableBashurverse(int id, int meta, int number, int target)
    {
