...
public class BashPackCore
{
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		//Register food first.
		itemRawBacon = new ItemFood(modPropertiesManager.modProperties.itemID_RawBacon, 1, 0.3F, true).setTextureName("bashpack:bacon_raw").setUnlocalizedName("rawbacon");
		itemSoggyBacon = new ItemFood(modPropertiesManager.modProperties.itemID_SoggyBacon, 2, 0.6F, true).setTextureName("bashpack:bacon_soggy").setUnlocalizedName("soggybacon");
		itemLimpBacon = new ItemFood(modPropertiesManager.modProperties.itemID_LimpBacon, 4, 0.8F, true).setTextureName("bashpack:bacon_limp").setUnlocalizedName("limpbacon");
		itemCrispyBacon = new ItemFood(modPropertiesManager.modProperties.itemID_CrispyBacon, 8, 1.2F, true).setTextureName("bashpack:bacon_crispy").setUnlocalizedName("crispybacon");
		itemBurntBacon = new ItemFood(modPropertiesManager.modProperties.itemID_BurntBacon, 1, 0.1F, true).setTextureName("bashpack:bacon_burnt").setUnlocalizedName("burntbacon");
		...
		itemRawBaconSword = new ItemSword(modPropertiesManager.modProperties.itemID_RawBaconSword, toolMaterialRawBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:raw_sword").setUnlocalizedName("raw_sword");
		itemRawBaconPickaxe = new ItemPickaxe(modPropertiesManager.modProperties.itemID_RawBaconPickaxe, toolMaterialRawBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:raw_pickaxe").setUnlocalizedName("raw_pickaxe");
		itemRawBaconAxe = new ItemAxe(modPropertiesManager.modProperties.itemID_RawBaconAxe, toolMaterialRawBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:raw_axe").setUnlocalizedName("raw_axe");
		itemRawBaconShovel = new ItemSpade(modPropertiesManager.modProperties.itemID_RawBaconShovel, toolMaterialRawBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:raw_shovel").setUnlocalizedName("raw_shovel");
		itemRawBaconHoe = new ItemHoe(modPropertiesManager.modProperties.itemID_RawBaconHoe, toolMaterialRawBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:raw_hoe").setUnlocalizedName("raw_hoe");

		itemSoggyBaconSword = new ItemSword(modPropertiesManager.modProperties.itemID_SoggyBaconSword, toolMaterialSoggyBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:soggy_sword").setUnlocalizedName("soggy_sword");
		itemSoggyBaconPickaxe = new ItemPickaxe(modPropertiesManager.modProperties.itemID_SoggyBaconPickaxe, toolMaterialSoggyBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:soggy_pickaxe").setUnlocalizedName("soggy_pickaxe");
		itemSoggyBaconAxe = new ItemAxe(modPropertiesManager.modProperties.itemID_SoggyBaconAxe, toolMaterialSoggyBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:soggy_axe").setUnlocalizedName("soggy_axe");
		itemSoggyBaconShovel = new ItemSpade(modPropertiesManager.modProperties.itemID_SoggyBaconShovel, toolMaterialSoggyBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:soggy_shovel").setUnlocalizedName("soggy_shovel");
		itemSoggyBaconHoe = new ItemHoe(modPropertiesManager.modProperties.itemID_SoggyBaconHoe, toolMaterialSoggyBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:soggy_hoe").setUnlocalizedName("soggy_hoe");

		itemLimpBaconSword = new ItemSword(modPropertiesManager.modProperties.itemID_LimpBaconSword, toolMaterialLimpBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:limp_sword").setUnlocalizedName("limp_sword");
		itemLimpBaconPickaxe = new ItemPickaxe(modPropertiesManager.modProperties.itemID_LimpBaconPickaxe, toolMaterialLimpBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:limp_pickaxe").setUnlocalizedName("limp_pickaxe");
		itemLimpBaconAxe = new ItemAxe(modPropertiesManager.modProperties.itemID_LimpBaconAxe, toolMaterialLimpBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:limp_axe").setUnlocalizedName("limp_axe");
		itemLimpBaconShovel = new ItemSpade(modPropertiesManager.modProperties.itemID_LimpBaconShovel, toolMaterialLimpBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:limp_shovel").setUnlocalizedName("limp_shovel");
		itemLimpBaconHoe = new ItemHoe(modPropertiesManager.modProperties.itemID_LimpBaconHoe, toolMaterialLimpBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:limp_hoe").setUnlocalizedName("limp_hoe");

		itemCrispyBaconSword = new ItemSword(modPropertiesManager.modProperties.itemID_CrispyBaconSword, toolMaterialCrispyBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:crispy_sword").setUnlocalizedName("crispy_sword");
		itemCrispyBaconPickaxe = new ItemPickaxe(modPropertiesManager.modProperties.itemID_CrispyBaconPickaxe, toolMaterialCrispyBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:crispy_pickaxe").setUnlocalizedName("crispy_pickaxe");
		itemCrispyBaconAxe = new ItemAxe(modPropertiesManager.modProperties.itemID_CrispyBaconAxe, toolMaterialCrispyBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:crispy_axe").setUnlocalizedName("crispy_axe");
		itemCrispyBaconShovel = new ItemSpade(modPropertiesManager.modProperties.itemID_CrispyBaconShovel, toolMaterialCrispyBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:crispy_shovel").setUnlocalizedName("crispy_shovel");
		itemCrispyBaconHoe = new ItemHoe(modPropertiesManager.modProperties.itemID_CrispyBaconHoe, toolMaterialCrispyBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:crispy_hoe").setUnlocalizedName("crispy_hoe");

		itemBurntBaconSword = new ItemSword(modPropertiesManager.modProperties.itemID_BurntBaconSword, toolMaterialBurntBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:burnt_sword").setUnlocalizedName("burnt_sword");
		itemBurntBaconPickaxe = new ItemPickaxe(modPropertiesManager.modProperties.itemID_BurntBaconPickaxe, toolMaterialBurntBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:burnt_pickaxe").setUnlocalizedName("burnt_pickaxe");
		itemBurntBaconAxe = new ItemAxe(modPropertiesManager.modProperties.itemID_BurntBaconAxe, toolMaterialBurntBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:burnt_axe").setUnlocalizedName("burnt_axe");
		itemBurntBaconShovel = new ItemSpade(modPropertiesManager.modProperties.itemID_BurntBaconShovel, toolMaterialBurntBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:burnt_shovel").setUnlocalizedName("burnt_shovel");
		itemBurntBaconHoe = new ItemHoe(modPropertiesManager.modProperties.itemID_BurntBaconHoe, toolMaterialBurntBacon).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:burnt_hoe").setUnlocalizedName("burnt_hoe");

		//Register bacon armor.
		itemRawBaconHelmet 			= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_RawBaconHelmet, armorMaterialRawBacon, "raw", 0, 0, 1, 0.1F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:raw_helmet").setUnlocalizedName("raw_helmet");
		itemRawBaconChestplate 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_RawBaconChestplate, armorMaterialRawBacon, "raw", 0, 1, 2, 0.2F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:raw_chestplate").setUnlocalizedName("raw_chestplate");
		itemRawBaconLeggings 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_RawBaconLeggings, armorMaterialRawBacon, "raw", 0, 2, 1, 0.1F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:raw_leggings").setUnlocalizedName("raw_leggings");
		itemRawBaconBoots 			= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_RawBaconBoots, armorMaterialRawBacon, "raw", 0, 3, 1, 0.1F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:raw_boots").setUnlocalizedName("raw_boots");

		itemSoggyBaconHelmet 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_SoggyBaconHelmet, armorMaterialSoggyBacon, "soggy", 0, 0, 2, 0.3F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:soggy_helmet").setUnlocalizedName("soggy_helmet");
		itemSoggyBaconChestplate	= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_SoggyBaconChestplate, armorMaterialSoggyBacon, "soggy", 0, 1, 3, 0.4F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:soggy_chestplate").setUnlocalizedName("soggy_chestplate");
		itemSoggyBaconLeggings 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_SoggyBaconLeggings, armorMaterialSoggyBacon, "soggy", 0, 2, 2, 0.3F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:soggy_leggings").setUnlocalizedName("soggy_leggings");
		itemSoggyBaconBoots 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_SoggyBaconBoots, armorMaterialSoggyBacon, "soggy", 0, 3, 2, 0.3F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:soggy_boots").setUnlocalizedName("soggy_boots");

		itemLimpBaconHelmet 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_LimpBaconHelmet, armorMaterialLimpBacon, "limp", 0, 0, 4, 0.5F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:limp_helmet").setUnlocalizedName("limp_helmet");
		itemLimpBaconChestplate 	= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_LimpBaconChestplate, armorMaterialLimpBacon, "limp", 0, 1, 5, 0.6F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:limp_chestplate").setUnlocalizedName("limp_chestplate");
		itemLimpBaconLeggings 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_LimpBaconLeggings, armorMaterialLimpBacon, "limp", 0, 2, 4, 0.5F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:limp_leggings").setUnlocalizedName("limp_leggings");
		itemLimpBaconBoots 			= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_LimpBaconBoots, armorMaterialLimpBacon, "limp", 0, 3, 4, 0.5F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:limp_boots").setUnlocalizedName("limp_boots");

		itemCrispyBaconHelmet 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_CrispyBaconHelmet, armorMaterialCrispyBacon, "crispy", 0, 0, 8, 0.7F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:crispy_helmet").setUnlocalizedName("crispy_helmet");
		itemCrispyBaconChestplate 	= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_CrispyBaconChestplate, armorMaterialCrispyBacon, "crispy", 0, 1, 9, 0.9F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:crispy_chestplate").setUnlocalizedName("crispy_chestplate");
		itemCrispyBaconLeggings 	= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_CrispyBaconLeggings, armorMaterialCrispyBacon, "crispy", 0, 2, 8, 0.7F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:crispy_leggings").setUnlocalizedName("crispy_leggings");
		itemCrispyBaconBoots 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_CrispyBaconBoots, armorMaterialCrispyBacon, "crispy", 0, 3, 8, 0.7F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:crispy_boots").setUnlocalizedName("crispy_boots");

		itemBurntBaconHelmet 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_BurntBaconHelmet, armorMaterialBurntBacon, "burnt", 0, 0, 1, 0.1F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:burnt_helmet").setUnlocalizedName("burnt_helmet");
		itemBurntBaconChestplate 	= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_BurntBaconChestplate, armorMaterialBurntBacon, "burnt", 0, 1, 1, 0.1F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:burnt_chestplate").setUnlocalizedName("burnt_chestplate");
		itemBurntBaconLeggings 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_BurntBaconLeggings, armorMaterialBurntBacon, "burnt", 0, 2, 1, 0.1F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:burnt_leggings").setUnlocalizedName("burnt_leggings");
		itemBurntBaconBoots 		= new ItemEdibleArmor(modPropertiesManager.modProperties.itemID_BurntBaconBoots, armorMaterialBurntBacon, "burnt", 0, 3, 1, 0.1F).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:burnt_boots").setUnlocalizedName("burnt_boots");

		//Register misc items.
		itemBarbecueLighter = new ItemBarbecueLighter(modPropertiesManager.modProperties.itemID_BarbecueLighter);

		//Register blocks.
		blockRawBacon = new Block(modPropertiesManager.modProperties.blockID_RawBacon, Material.clay).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:bacon_raw").setUnlocalizedName("raw_bacon_block").setResistance(2.5F).setHardness(1.0F);
		blockSoggyBacon = new Block(modPropertiesManager.modProperties.blockID_SoggyBacon, Material.clay).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:bacon_soggy").setUnlocalizedName("soggy_bacon_block").setResistance(2.5F).setHardness(1.0F);
		blockLimpBacon = new Block(modPropertiesManager.modProperties.blockID_LimpBacon, Material.clay).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:bacon_limp").setUnlocalizedName("limp_bacon_block").setResistance(2.5F).setHardness(1.0F);
		blockCrispyBacon = new Block(modPropertiesManager.modProperties.blockID_CrispyBacon, Material.clay).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:bacon_crispy").setUnlocalizedName("crispy_bacon_block").setResistance(2.5F).setHardness(1.0F);
		blockBurntBacon = new Block(modPropertiesManager.modProperties.blockID_BurntBacon, Material.clay).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:bacon_burnt").setUnlocalizedName("burnt_bacon_block").setResistance(2.5F).setHardness(1.0F);
		blockBone = new Block(modPropertiesManager.modProperties.blockID_Bone, Material.rock).setCreativeTab(tabBashPackBacon).setTextureName("bashpack:bone").setUnlocalizedName("bone").setResistance(10.0F).setHardness(1.5F).setStepSound(Block.soundStoneFootstep);
		...
		//Register biomes.
		bashurBiome = new BiomeGenBashurverse(98);
